...
@section('content')
  <div class="min-h-screen w-full flex items-center justify-center">
    <div class="hidden lg:flex lg:w-6/12 flex justify-center">
      <svg class="w-8/12" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 570 511.67482" role="img" artist="Katerina Limpitsouni" source="https://undraw.co/">
        ...
        <path d="M489.25553,650.70367H359.81522a6.04737,6.04737,0,1,1,0-12.09473H489.25553a6.04737,6.04737,0,1,1,0,12.09473Z" transform="translate(-315 -194.16259)" fill="#6c63ff" />
      ...
      <div class="flex grow flex-col items-center justify-center mt-5">
        @if (session('status') == 'verification-link-sent')
          <div role="alert" class="alert alert-success mb-8">
            ...
            <span>A new email verification link has been emailed to you!</span>
          </div>
        @endif
        <h1 class="text-3xl font-bold text-center">Verify Email</h1>
        <p class="text-sm text-center mt-3">We have sent a verification link to {{ Auth::user()->email }}</p>
        <p class="text-sm text-center mt-3">Click on the link to complete verification process. You might need to check your <b>Spam Folder</b> </p>
        <form action="{{ route('verification.send') }}" method="POST" class="w-full mt-10">
          @csrf
