...
@section('content')
  <div class="min-h-screen w-full flex items-center justify-center">
    <div class="hidden lg:flex lg:w-6/12 flex justify-center">
      <svg class="w-8/12" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 793 551.73152" role="img" artist="Katerina Limpitsouni" source="https://undraw.co/">
    ...
    <div class="w-full lg:w-6/12 flex flex-col items-center justify-between h-screen p-12">
      ...
      <div class="w-full flex grow flex-col items-center justify-center mt-5">
        ...
        @endif
        <form action="{{ route('password.update') }}" method="POST" class="w-full mt-10">
          @csrf
